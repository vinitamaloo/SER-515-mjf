...
public class Tournament {
    ...
    // Cannot keep the method getTournamentTeams() public because Team class is
    // accessible only within the package, not outside the package.
    ...
    // Cannot keep the method getTournamentVenues() public because Venue class is
    // accessible only within the package, not outside the package.
